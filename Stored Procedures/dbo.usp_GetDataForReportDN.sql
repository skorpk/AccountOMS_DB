...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_GetDataForReportDN]
as
...
FROM dbo.vw_sprMKB10 WHERE MainDS between'I00' AND 'I99' --берем только до подрубрики I98 т.к I99 стоит в исключениях
...
DELETE FROM #tCases WHERE Age<18
