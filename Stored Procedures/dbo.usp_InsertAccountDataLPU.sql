...
insert #t5(N_ZAP ,ID_PAC ,IDCASE ,ID_C ,USL_OK ,VIDPOM 
			...
			,PRVS,OS_SLUCH ,IDSP ,ED_COL ,TARIF ,SUMV ,SANK_MEK ,SANK_MEE ,SANK_EKMP ,COMENTSL ,F_SP,IDDOCT,IT_SL )
SELECT N_ZAP,ID_PAC,IDCASE,ID_C,USL_OK,VIDPOM,
		...
		PRVS,OS_SLUCH,IDSP,ED_COL,TARIF,SUMV,SANK_MEK,SANK_MEE,SANK_EKMP,COMENTSL,F_SP,IDDOKT,IT_SL
...
--раскладываем данные по таблица в базе счета
	...
	insert t_Case(rf_idRecordCasePatient, idRecordCase, GUID_Case, rf_idV006, rf_idV008,
				  ...
				  IsSpecialCase, rf_idV010, AmountPayment, Comments,Age,[Emergency],rf_idDoctor,IT_SL)
	...
	select t2.id,t1.IDCASE,t1.ID_C, t1.USL_OK,t1.VIDPOM, 
			...
			,CASE WHEN t1.IDDOCT='0' THEN NULL ELSE t1.IDDOCT END,t1.IT_SL
...
GO
GRANT EXECUTE ON  [dbo].[usp_InsertAccountDataLPU] TO [db_AccountOMS]
GO
