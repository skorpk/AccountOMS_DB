...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[usp_ReportAmbulance_20150702]
		@dateEnd DATETIME, -- конечная дата регистрации счетов
		@reportYear smallint,--отчетный год
		@dateEndPay DATETIME,
		@endMonth TINYINT --конечный отчетный месяц
AS
...
GO
GRANT EXECUTE ON  [dbo].[usp_ReportAmbulance_20150702] TO [db_AccountOMS]
GO
