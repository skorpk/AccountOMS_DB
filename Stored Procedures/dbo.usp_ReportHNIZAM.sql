...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_ReportHNIZAM]			
			@dateEndReg DATETIME
as
...
SELECT DISTINCT c.id AS rf_idCase, cc.AmountPayment,f.CodeM,p.ENP,NULL AS BirthDay,CAST(NULL AS VARCHAR(10)) AS rf_idV025,d.idRow, c.rf_idV006 AS USL_OK,d.MainDS,c.rf_idRecordCasePatient
