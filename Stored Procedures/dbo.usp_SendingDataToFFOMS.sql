...
CREATE PROCEDURE [dbo].[usp_SendingDataToFFOMS]
		@reportYear SMALLINT,
...
SELECT /*ROW_NUMBER()*/ DENSE_RANK() OVER(ORDER BY rf_idCase ,ReportYear,ReportMonth) AS id, rf_idCase ,CodeM ,rf_idMO ,MONTH(@dateStartPay) ,YEAR(@dateStartPay),
...
update dbo.t_SendingDataIntoFFOMS SET IsFullDoubleDate=1 WHERE DKK1='sh131'
