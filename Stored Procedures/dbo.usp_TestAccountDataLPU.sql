...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[usp_TestAccountDataLPU]
			@doc xml,
			@patient xml,
			--@file varbinary(max),
			@fileName varchar(26),
...
--внес изменения т.к при зачистке данных в базе Реестров сведений за Страмным удалил хирургические операции.
	...
	EXEC usp_GetMeduslugiFromRegisterCaseDBOld @account--,@codeMO,@month,@year						
...
GO
GRANT EXECUTE ON  [dbo].[usp_TestAccountDataLPU] TO [db_AccountOMS]
GO
