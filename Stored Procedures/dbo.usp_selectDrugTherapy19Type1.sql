...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_selectDrugTherapy19Type1]
@rf_idCase bigint,
@rf_idN013 bigint,
@rf_idONKUSL bigint
AS
...
GO
GRANT EXECUTE ON  [dbo].[usp_selectDrugTherapy19Type1] TO [AccountsOMS]
GRANT EXECUTE ON  [dbo].[usp_selectDrugTherapy19Type1] TO [db_AccountOMS]
GO
