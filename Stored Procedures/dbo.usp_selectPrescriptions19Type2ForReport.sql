...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_selectPrescriptions19Type2ForReport]
...
'SELECT [rf_idCase]
      ...
      ,rtrim([DirectionMU]) -- код МУ из номенклатуры
	  ,s.[MUName]
...
GO
GRANT EXECUTE ON  [dbo].[usp_selectPrescriptions19Type2ForReport] TO [db_AccountOMS]
GO
