...
GO
CREATE NONCLUSTERED INDEX [IX_IdCase] ON [dbo].[t_260order_ONK] ([rf_idCase]) INCLUDE ([C_ZAB], [DATE_1], [DATE_2], [DET], [DS_ONK], [DS1], [GUID_Case], [IDDOKT], [LPU], [NHISTORY], [PROFIL_K], [PRVS], [Quantity], [SUM_M], [VERS_SPEC]) ON [PRIMARY]
GO
