CREATE TABLE [dbo].[t_SNILSAmbulanceFFOMS]
(
...
GO
GRANT SELECT ON  [dbo].[t_SNILSAmbulanceFFOMS] TO [db_AccountOMS]
GRANT INSERT ON  [dbo].[t_SNILSAmbulanceFFOMS] TO [db_AccountOMS]
GO
