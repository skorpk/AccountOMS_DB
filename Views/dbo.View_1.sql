...
AS
SELECT  rf_idCase, SUM(AmountDeduction) AS Eks
FROM     dbo.t_PaymentAcceptedCase2
WHERE  (DateRegistration BETWEEN CONVERT(DATETIME, '2019-01-01 00:00:00', 102) AND CONVERT(DATETIME, '2019-08-02 00:00:00', 102)) AND (Letter = 'F')
GROUP BY rf_idCase
GO
