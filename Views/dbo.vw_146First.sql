...
WHERE     (a.DateRegistration BETWEEN '20161211' AND '20170120' AND a.ReportYear = 2016)
...
GO
GRANT SELECT ON  [dbo].[vw_146First] TO [db_AccountOMS]
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[5] 4[29] 2[51] 3) )"
      End
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_146First', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_146First', NULL, NULL
GO
