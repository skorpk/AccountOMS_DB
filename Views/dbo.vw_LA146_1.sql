...
GO
GRANT SELECT ON  [dbo].[vw_LA146_1] TO [db_AccountOMS]
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[27] 4[20] 2[26] 3) )"
      End
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_LA146_1', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_LA146_1', NULL, NULL
GO
