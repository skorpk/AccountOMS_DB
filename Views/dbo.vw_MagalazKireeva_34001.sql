...
CREATE VIEW [dbo].[vw_MagalazKireeva_34001]
as
...
WHERE f.CodeM='115309' AND m.DateHelpBegin>='20130101' AND m.DateHelpBegin<='20131231 23:59:59'

GO
GRANT SELECT ON  [dbo].[vw_MagalazKireeva_34001] TO [db_AccountOMS]
GO
