...
WHERE     (c.IsChildTariff = 1) AND (m.MUGroupCode = 2) AND (a.ReportMonth >= 1) AND (a.ReportMonth < 7) AND (a.ReportYear = 2012) AND 
                      (f.DateRegistration > '20120101') AND (f.DateRegistration < '20120721')
GO
GRANT SELECT ON  [dbo].[vw_vkAmbl2012] TO [db_AccountOMS]
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_vkAmbl2012', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_vkAmbl2012', NULL, NULL
GO
