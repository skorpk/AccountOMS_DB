...
WHERE     (c.IsChildTariff = 1) AND (m.MUGroupCode = 55) AND (a.ReportMonth = 12) AND (a.ReportYear = 2011) AND (f.DateRegistration > '20111201') AND 
                      (f.DateRegistration < '20120221')
GO
GRANT SELECT ON  [dbo].[vw_vkDnst2011] TO [db_AccountOMS]
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_vkDnst2011', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_vkDnst2011', NULL, NULL
GO
